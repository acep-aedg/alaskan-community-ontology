...
## List of Classes in the Electricity Context
...
- **Properties**:
  ...
  - geometry (WKT ?): All grids are continuous. Could this be a shape that includes all the PowerPlants and PowerLines?
...
### ServiceArea
- **Definition**: The RCA associates every regulated electric utitlity with a service area.
- **SpatialRelationships**: 
...
### Interties
- **Definition**: This is the lookup table in the Energy Stats Workbooks used to describe grids. Interies connect new communities to existing grids and they become active in a defined year.
- **SpatialRelationships**: 
  - CONTAINS PowerLines (transmission and distribution lines)
  - CONTAINS PowerStations (power providers)
  - CONTAINS Communities (consumers) demand, load ?
