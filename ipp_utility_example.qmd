...
Fairbanks has more distributed power generation than other communities in part because of the evolution of the distribution of the power plants developed at University of Alaska Fairbanks, Ft. Wainwright, Eielson Air Force Base, and later additional GVEA operated power plants using diesel, HAGO, and naphtha generation resources at the North Pole refinery associated with completion of the Trans-Alaska Pipeline System (TAPS) in 1977. In addition, there are, or have been, other utilities besides electrical utilities:
