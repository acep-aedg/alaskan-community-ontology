---
title: "Energy (besides Electricity)"
subtitle: "Descriptions of wider Energy-related entities in the Alaska Community Ontology"
date: 2025-05-23
---

Unfortunately, without specific data sources to provide and constrain attributes, classes and relationships cannot yet be defined within the context of AEDG. As data sources are identified, this page will evolve. For now, it is incomplete.
...
There is a special category of communities who have fuel delivered by airplant. AK DOT is interested in seeing a list of these for safety assessments, and Mike Jones is interested because of his research on airports. There is an ancillary dataset to DCRA's fuel survey for fuel delivery methods. 
...
- Prices
  - https://www.consultenergy.org/propane/ak/ has prices for Fairbanks and Anchorage
  - [EIA residential propane](https://www.eia.gov/dnav/pet/pet_pri_wfr_a_EPLLPA_PRS_dpgal_w.htm)
...
- [RCA search](https://rca.alaska.gov/RCAWeb/RCALibrary/SearchResults.aspx?t=cert&p=typesearch&cert=&entity=&utiltype=5d3eb685-14c3-4d4a-9b0f-e56cb92bbeca) 
