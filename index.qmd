...
- Classes: Types of entities. The base Class is Community; dispite the fact that this might be the hardest Class to define, Community is the organizational principle of previous versions of AEDG, so we will start with that. Other Classes (Borough, AEARegion, ZipCode) will be defined in relation to Community. 
...
![Initial Brainstorming.](images/brainstorming_board.jpg){fig-alt="first graph of communities" width=200 fig-align="left"}
