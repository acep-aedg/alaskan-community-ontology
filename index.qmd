...
3. As consensus is reached (often in direct messages or conversations during meetings), the resolution migrates to the data model and then if we are lucky to this ontology.
