...
This repository was founded to support needed conversations regarding a foundational element of Alaska Energy Data Gateway (AEDG): the need to crosswalk between socio-economic and energy data recorded at different spatial scales. AEDG has historically displayed data for individual communities. However, some datasets, such as electrical grids and service areas, are only available for groups of communities and eventually AEDG will also display data for boroughs and legislative districts so community data itself will need to be aggregated.

To accomplish the computation of these aggregates in a reproducible way, a crosswalk between conceptual groupings of communities is required. This conceptual model will be applicable to diverse types of data. It will also guide the development of the algorithms that compute the aggregations and convert between them. 
