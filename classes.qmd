...
### FedRecognizedTribes
- **Definition**: For the purposes of tracking energy in Alaska, the definition [should|will|could] be restricted to the 229 Federally recognized Tribes - sovereign governments. The 1975 Indian Self-Determination and Education Assistance Act allows tribes to contract with the federal government to provide services in place of federal agencies. US Supreme Court ruled in 2021 that Alaska Native Corps (RegionalCorps?) are Federally Recognized Tribes and are eligible for COVID relief funds. 
- **SpatialRelationships**: 
- **Analogous Standards**:
  ...
  - OEO:provider (an organization with a role) provides a OEO:service
- **References**:
...
- **Analogous Standards**:
  ...
  - [dc:Location](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#http://purl.org/dc/terms/Location)
  - OEO:subregion (of Alaska and of SenateDistrict)
- **References**:
...
- **SpatialRelationships**: 
  - CONTAINS TransmissionLines
  - CONTAINS PowerStations
  - CONTAINS Utilities
  - CONTAINS Loads
- **Analogous Standards**:
  ...
  - OEO:electricity grid (an aggregate of material entities that has parts: power stations and transmission lines)
- **Properties**:
  - microgrid (boolean): True/False (need a definition for this)
  - capacity (int): megawatts MW
  - geometry (WKT Polygon): This assumes all grids are continuous. Otherwise use MultiPolygon


### Utilities
- **Definition**: The corporate or governmental entity that runs the Grid
- **SpatialRelationships**: 
  - WITHIN Grids (Can have multiple utilities per grid, Railbelt. Can also be fragmented, AVEC)
- **Analogous Standards**:
  - https://schema.org/Corporation
  - [dc:Agent](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#http://purl.org/dc/terms/Agent)
  - OEO:provider (an organization with a role) provides commercial OEO:service
- **Properties**:
  ...
  - geometry (WKT MultiPolygon): This may get interesting with discontinuous utilities such as AVEC, worth the complexity, press on.
...
- **SpatialRelationships**: 
  ...
  - TOUCHES Loads
- **Analogous Standards**:
  - OEO:electricity grid component
...
- **Properties**:
  ...
  - voltage (int): voltage of line in kV (by definition above 69 kV, but not always in Alaska)
...
- **SpatialRelationships**: 
  - TOUCHES TransmissionLines
  - WITHIN Grids
- **Analogous Standards**:
  - [dc:PhysicalResource](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#http://purl.org/dc/terms/PhysicalResource)
  - OEO:power plant (which is an energy tranformation unit)
- **Properties**:
...
### Loads (consumption)
- **Definition**: Endpoints of grid, quantified by consumption. Data is grid-wide for now, we would love to narrow down in the future.
- **SpatialRelationships**: 
  - WITHIN Grids
  - TOUCHES TransmissionLines
- **Properties**:
  - geometry (WKT MultiPolygon): same as Grid? Utility?
...
- **Analogous Standards**:
  - https://schema.org/DefinedRegion - Arbitrary!  haha
  - [dc:Location](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#http://purl.org/dc/terms/Location)
  - OEO:subregion (of the unincorporated Borough)
- **References**:
  - https://gis.data.alaska.gov/datasets/DCCED::alaska-borough-and-census-area-boundaries/about
- **Properties**:
...
- **Analogous Standards**:
  ...
  - [dc:Location](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#http://purl.org/dc/terms/Location)
  - OEO:subregion (of the United States and of Alaska)
- **References**:
