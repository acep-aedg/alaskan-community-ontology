...
[ANCSA Regional's Overview](https://ancsaregional.com/overview-of-entities/) is the best description of the different tribal entities in Alaska. 

- Tribes can be federally recognized. Does this define a tribe in the context of AEDG?
...
If the terms don't make sense, check the [Census Glossary](https://www.census.gov/glossary/).
